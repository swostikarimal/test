...
'''
Dat Ingestion logic for Google Analytics user acqusition tables into data storage
...
ACQUISITION_METRICS = [
    "firstUserPrimaryChannelGroup", "firstUserDefaultChannelGroup", "firstUserMedium", "firstUserSource",
    "firstUserSourceMedium", "firstUserSourcePlatform", "firstUserCampaignName",
    "firstUserGoogleAdsAccountName", "firstUserGoogleAdsAdNetworkType", "firstUserGoogleAdsAdGroupName"
]
...
def fetch_ga_data(client, property_id: str, dimension_name: str) -> pd.DataFrame:
    ...
    request = RunReportRequest(
        ...
        metrics=[
            ...
            Metric(name="userKeyEventRate"), Metric(name="activeUsers"), Metric(name="eventCount"),
            Metric(name="engagedSessions"), Metric(name="Sessions"), Metric(name="userEngagementDuration")
        ],
...
def main():
    ...
    properties = {
        "properties/347471683": {"subfolder": "userAcquisition", "overwrite": True}, 
    #     "properties/188625672": {"subfolder": "userAcquisition", "overwrite": False} 
    }
